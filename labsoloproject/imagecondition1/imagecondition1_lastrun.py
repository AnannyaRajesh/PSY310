...
expName = 'imagecondition1'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\User\\Desktop\\AU\\SEM5\\PSY310\\labsoloproject\\imagecondition1\\imagecondition1_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    image = visual.ImageStim(
        ...
        ori=0.0, pos=(0, 0.1), draggable=False, size=(0.5, 0.3),
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('imagecondition.csv'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, text, image, textbox, button],
        )
        ...
        while continueRoutine:
            ...
            if button.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
    ...
    while continueRoutine and routineTimer.getTime() < 90.0:
        ...
        if button_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > button_2.tStartRefresh + 90.0-frameTolerance:
                # keep track of stop time/frame for later
                button_2.tStop = t  # not accounting for scr refresh
                button_2.tStopRefresh = tThisFlipGlobal  # on global time
