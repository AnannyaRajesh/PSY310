...
expName = 'cw_6sept'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\User\\Desktop\\AU\\SEM5\\PSY310\\Compensatory Work\\cw_6sept_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStaircase in staircase:
        ...
        thisExp.addData('key_resp', key_resp.corr)
        # check responses
