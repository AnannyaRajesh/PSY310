...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\User\\Desktop\\AU\\SEM5\\PSY310\\Experiments\\wordpriming\\wordpriming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/User/Desktop/AU/SEM5/PSY310/Experiments/study_test.xlsx'), 
        seed=None, 
    )
    ...
    trials_2 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/User/Desktop/AU/SEM5/PSY310/Experiments/test.xlsx'), 
        seed=None, 
    )
