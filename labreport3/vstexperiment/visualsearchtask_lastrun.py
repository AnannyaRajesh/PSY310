...
expName = 'visualsearchtask'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\User\\Desktop\\AU\\SEM5\\PSY310\\Experiments\\visualsearchtask\\visualsearchtask_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="In this task, you are required to look for and mouse click on the letter 'T'. ",
        font='Arial',
    ...
    target = visual.TextStim(win=win, name='target',
        text='',
        font='Open Sans',
        pos=[0,0], draggable=False, height=0.1, wrapWidth=None, ori=1.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
